<template>
  <div class="navigation">
    <div class="navigation_logo">
        <a href="#" class="logo">
            <svg width="27" height="40" viewBox="0 0 27 40" fill="none" class="logo+img" xmlns="http://www.w3.org/2000/svg">
    ...
    <nav class="navigation_menu">
        <menu class="menu">
            <li class="menu_item">
                <a href="#" class="menu_item_link" title="Dashboard">
                    Dashboard
                </a>    
            </li> 
            <li class="menu_item">
                <a href="#" class="menu_item_link" title="Отчёты">
                    Отчёты
                </a>    
            </li> 
            <li class="menu_item">
                <a href="#" class="menu_item_link" title="Статистика">
                    Статистика
                </a>    
            </li> 
            <li class="menu_item">
                <a href="#" class="menu_item_link" title="Офферы">
                    Офферы
                </a>    
            </li> 
            <li class="menu_item">
                <a href="#" class="menu_item_link" title="Инструменты">
                    Инструменты
                </a>    
           </li> 
            <li class="menu_item">
                <a href="#" class="menu_item_link" title="Разработчикам">
                    Разработчикам
                </a>    
            </li> 
            <li class="menu_item menu_item--active" title="Сервисы">
                <a href="#" class="menu_item_link" >
                    Сервисы
                </a>    
            </li> 
            <li class="menu_item">
                <a href="#" class="menu_item_link" title="Финансы">
                    Финансы
                </a>    
            </li> 
        </menu>
